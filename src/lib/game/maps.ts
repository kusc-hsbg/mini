...
export const TILE_INFO: Record<string, TileInfo> = {
  ",": { color: "#7ed957", solid: false, accent: "#96e86f", outdoor: true },
  ";": { color: "#5fc93f", solid: false, accent: "#7ed957", outdoor: true },
  d: { color: "#f0cf87", solid: false, accent: "#f7dc9c", outdoor: true },
  s: { color: "#ffe6a0", solid: false, accent: "#fff0bd", outdoor: true },
  "-": { color: "#f4dca8", solid: false, accent: "#e6c688", outdoor: true },
  "=": { color: "#6b7280", solid: false, accent: "#818997", outdoor: true },
  "~": { color: "#28a0e8", solid: true, accent: "#63c2ff", outdoor: true },
  W: { color: "#2f9fe0", solid: false, accent: "#63c2ff", outdoor: true }, // 얕은 물(주행 가능, 보트 없으면 감속)
  ".": { color: "#e7e0d0", solid: false, accent: "#d9d2c1" },
  w: { color: "#c99a63", solid: false, accent: "#bd8e57" },
  k: { color: "#8e6b43", solid: false, accent: "#7e5f3c" },
  c: { color: "#6b8ad6", solid: false, accent: "#5f7fce" },
  m: { color: "#e07a7a", solid: false, accent: "#d66d6d" },
  g: { color: "#5fc487", solid: false, accent: "#54b87b" },
  p: { color: "#eecb8f", solid: false, accent: "#ffe6b8" },
